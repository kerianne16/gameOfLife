...
class Game {
    ...
    public func setStatus(index:Int, status:Bool) {
        let x = index % Game.shared.columns
        let y = index / Game.shared.columns
    ...
    public func setOscillator(oscillator: Preset, at: CGPoint) {
    ...
    public func setOscillator(oscillator: Preset) {
